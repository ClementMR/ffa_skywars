...
core.register_node("maptools:playerclip", {
...
core.register_node("maptools:fake_walkable", {
	description = S("Player Clip"),
	range = 12,
	stack_max = 10000,
	inventory_image = "default_steel_block.png^dye_green.png",
...
core.register_node("maptools:fake_walkable_pointable", {
	description = S("Player Clip"),
	range = 12,
	stack_max = 10000,
	inventory_image = "default_steel_block.png^dye_green.png",
...
core.register_node("maptools:ignore_like", {
...
core.register_node("maptools:ignore_like_no_clip", {
...
core.register_node("maptools:ignore_like_no_point", {
...
core.register_node("maptools:ignore_like_no_clip_no_point", {
...
core.register_node("maptools:playerclip_bottom", {
...
for pusher_num=1,10,1 do
	core.register_node("maptools:pusher_" .. pusher_num, {
...
core.register_node("maptools:nobuild", {
...
core.register_node("maptools:nointeract", {
...
core.register_node("maptools:ladder", {
...
core.register_node("maptools:permanent_fire", {
...
core.register_node("maptools:fake_fire", {
...
core.register_node("maptools:igniter", {
	drawtype = "airlike",
	range = 12,
	stack_max = 10000,
